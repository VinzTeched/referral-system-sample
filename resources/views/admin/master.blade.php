...
<head>
    ...
    <link rel="stylesheet" href="{{asset('admin/css/vendor/bootstrap-toggle.min.css')}}">
    <!-- fontawesome 5  -->
    ...
    <link rel="stylesheet" href="{{asset('admin/css/vendor/nice-select.css')}}">
    <!-- code preview css -->
    <link rel="stylesheet" href="{{asset('admin/css/vendor/prism.css')}}">
    <!-- select 2 css -->
    <link rel="stylesheet" href="{{asset('admin/css/vendor/select2.min.css')}}">
    <!-- data table css -->
    <link rel="stylesheet" href="{{asset('admin/css/vendor/datatables.min.css')}}">
    <!-- jvectormap css -->
    <link rel="stylesheet" href="{{asset('admin/css/vendor/jquery-jvectormap-2.0.5.css')}}">
    <!-- datepicker css -->
    <link rel="stylesheet" href="{{asset('admin/css/vendor/datepicker.min.css')}}">
    <!-- timepicky for time picker css -->
    <link rel="stylesheet" href="{{asset('admin/css/vendor/jquery-timepicky.css')}}">
    <!-- bootstrap-clockpicker css -->
    <link rel="stylesheet" href="{{asset('admin/css/vendor/bootstrap-clockpicker.min.css')}}">
    <!-- bootstrap-pincode css -->
    <link rel="stylesheet" href="{{asset('admin/css/vendor/bootstrap-pincode-input.css')}}">
    <!-- dashdoard main css -->
...
<script src="{{asset('admin/js/vendor/jquery.nice-select.min.js')}}"></script>
...
<!-- code preview js -->
<script src="{{asset('admin/js/vendor/prism.js')}}"></script>
<!-- seldct 2 js -->
